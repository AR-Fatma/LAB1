...
public class PointCPTest
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
		if (args[0]== "C") point = new PointC(Double.valueOf(args[1]).doubleValue(),Double.valueOf(args[2]).doubleValue());
		else point = new PointP(Double.valueOf(args[1]).doubleValue(),Double.valueOf(args[2]).doubleValue());
	}
    catch(Exception e)
    {
  ...
  private static Point getInput() throws IOException
  {
	...
	if (coordType == 'C') return new PointC(a,b);
	else return new PointP(a,b);
